...
def test_mamba():
    ...
    model = Mamba(d_model=d_model, d_state=d_state, d_conv=d_conv, expand=expand).to(device)

    # Create dummy input tensor for inference and move to GPU
    batch_size = 4
    seq_len = 10
    ...
    flops, params = get_model_complexity_info(model, (4, 128),
